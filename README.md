...
- **📦 Open Source Contributions**: Published NPM packages including `qrlayout-core`, `qrlayout-ui`, and `env-drift-check` with 6,000+ total downloads.
...
| :--- | :--- | :--- | :--- |
| **qrlayout-core** | Core logic library for QR layout generation with TypeScript | 2,700+ | [View Package](https://www.npmjs.com/package/qrlayout-core) |
| **qrlayout-ui** | Framework-agnostic UI components for QR layout designer | 1,800+ | [View Package](https://www.npmjs.com/package/qrlayout-ui) |
| **env-drift-check** | CLI tool to detect drift between .env files | 1,600+ | [View Package](https://www.npmjs.com/package/env-drift-check) |
